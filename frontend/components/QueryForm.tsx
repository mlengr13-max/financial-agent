...
export const QueryForm = forwardRef<{ submit: () => Promise<void> }, QueryFormProps>(
  ({ onAnalysisComplete, queryValue = '' }, ref) => {
    ...
    useEffect(() => {
      // Update query when queryValue prop changes
      if (queryValue) {
        setQuery(queryValue);
      }
    }, [queryValue]);
